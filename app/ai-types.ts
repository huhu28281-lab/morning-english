...
export type ConnectionStatus = { openai: boolean; cloudflare:boolean; accountId:string; freePlanConfirmed:boolean; usage:CloudflareUsage|null; azure: boolean; endpoint: string; ready: boolean };
