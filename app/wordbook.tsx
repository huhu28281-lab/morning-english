...
export default function Wordbook({book,rate,onPractice}:{book:ReturnType<typeof useVocabulary>;rate:number;onPractice:(text:string)=>void}) {
  ...
  return <div className="feature-page">
    <div className="page-heading"><div><p className="eyebrow">WORDS THAT WORK FOR YOU</p><h1>내 표현이 되는 단어장.</h1><p className="heading-sub">직장인 표현 30개부터, 수업에서 담은 문장까지.</p></div><button className="primary-button" onClick={()=>{setDraft(emptyWord);setOpen(true);}}><Plus size={18}/>직접 추가</button></div>
